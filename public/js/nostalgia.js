    ...
    var Nostalgia = function (options, page, slide, audio, config, configDefault) {
        ...
        this.openTab = function (tabToOpen, event) {
            ...
            if (tabToOpen == 'left') {
                ...
                $this.nostalgiaTab.animate({width: $this.nostalgiaTabWidth + '%'}, {
        ...
        this.closeTab = function (tabToClose, event) {
            $this.showTabIcon(false, tabToClose, {
                complete: function () {
                    $(':input,a').qtip('destroy');
                    $this.nostalgiaTab.animate({width: '0%'}, {
                        duration: 1000, easing: 'easeOutExpo', complete: function () {
        ...
        this.showNavigationMenu = function (show, event) {
            if (show) {
                $this.nostalgiaNavigationMenu.animate({height: $this.nostalgiaNavigationMenuHeight}, {
                ...
                $this.nostalgiaNavigationMenu.animate({height: '0px'}, {
                    duration: 500, complete: function () {
                        $this.nostalgiaNavigationMenuList.trigger('updateSizes');
                        $this.doEvent(event);
                    }
        ...
        this.moveNavigation = function (tabToOpen, event) {
            ...
            if (tabToOpen == 'left') {
                ...
                $this.nostalgiaNavigation.animate({left: $this.nostalgiaTabWidth + $this.nostalgiaTabMargin + '%'}, {
                    duration: 1000,
                    complete: function () {
                        $this.doEvent(event);
                    }
                ...
                $this.nostalgiaNavigation.animate({right: $this.nostalgiaTabWidth + $this.nostalgiaTabMargin + '%'}, {
                    duration: 1000,
                    complete: function () {
                        $this.doEvent(event);
                    }
                ...
                if (position.left == $this.nostalgiaNavigationStartLeftPosition) $this.doEvent(event);
                    ...
                    $this.nostalgiaNavigation.css({right: 'auto', left: position.left + '%'});
                    $this.nostalgiaNavigation.animate({left: $this.nostalgiaNavigationStartLeftPosition + '%'}, {
                        duration: 1000,
                        complete: function () {
                            $this.doEvent(event);
                        }
        ...
        this.blink = function (element) {
            $(element).animate({opacity: ($(element).css('opacity') == 1 ? 0.2 : 1)}, 500, function () {
                $this.blink($(this));
            });
        };
